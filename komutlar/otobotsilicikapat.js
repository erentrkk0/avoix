...
exports.run = (client, message, args) => { 
  ...
  message.reply(`**Sadece bu sohbet kanalında** tüm botların mesajını 2 dakika sonra silme şu anda bu özellik devre dışı. ${client.emojis.cache.get("647746144155467786")}

...
if (!member) return message.channel.send(`Kadın Olarak Kayıt Edeceğin Kullanıcıyı Belirtmelisin ! `)
let isim = args[1]
...
.setTitle(`${client.user.username} - Kadın `)
.setColor('BLACK')
.setDescription(`Kadın Olarak Kayıt Edilen Kullanıcı: ${member} \n Kadın Olarak Kayıt Eden Yetkili: <@!${message.author.id}> \n Kadın Olarak Kayıt Eden Kullanıcının Kayıt Sayısı: **${kayıtsayı ? `**${kayıtsayı}**` : "0"}**`)
